...
public final class GCEItems {
    ...
    public static final SlimefunItemStack WATER_EGG = new SlimefunItemStack("GCE_WATER_EGG", new ItemStack(Material.TURTLE_SPAWN_EGG), "&9Water Egg", "Contains water", LoreBuilder.RIGHT_CLICK_TO_USE);
